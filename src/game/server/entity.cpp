...
{
	return int_round(CheckPos.x)/32 < -200 || int_round(CheckPos.x)/32 > GameServer()->Collision()->GetWidth()+200 ||
			int_round(CheckPos.y)/32 < -200 || int_round(CheckPos.y)/32 > GameServer()->Collision()->GetHeight()+200 ? true : false;
}
